...
import cv2
import time
from ml.main import utils
import pickle
import datetime
import numpy as np
import tensorflow as tf
from ml.mtcnn.MTCNN import DetectionMtcnn
from ml.src.modules.models import ArcFaceModel
from scipy.spatial.distance import euclidean
from ml.src.modules.utils import set_memory_growth, load_yaml, l2_norm
...
class RECOG:
    def __init__(self):
        ...
        self.embed = "./ml/embds_dict_ad.pkl"
        self.input_size = 112
        ...
        self.model = ArcFaceModel(size=self.input_size,
                         ...
                         training=False)
        self.ckpt_path = tf.train.latest_checkpoint(self.path+'/ml/checkpoints/' + self.sub_name)
