...
from project.ml.face_recog.project.libs.recognition.modules import utils
from project.ml.face_recog.project.libs.recognition.modules.utils import l2_norm
from scipy.spatial.distance import euclidean
from project.ml.face_recog.project.libs.recognition.modules.models import ArcFaceModel
from project.ml.face_recog.project.libs.recognition.modules.evaluations import get_val_data, perform_val
...
class SAVE_EMBDED:
    ...
    def save_multiple_embed(self,path):
        ...
        with open("project/ml/face_recog/project/information/embdding.pkl", "wb") as fi:
    ...
    def register(self,image, name):
        ...
        nam = np.array(names)
        embds_dict = dict(zip(nam, embd))
        with open("project/ml/face_recog/project/information/embdding.pkl", "rb") as fi:
            file = pickle.load(fi)
        file.update(embds_dict)
        out_put = open("project/ml/face_recog/project/information/embdding.pkl", "wb")
