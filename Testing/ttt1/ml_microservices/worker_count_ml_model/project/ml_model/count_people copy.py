...
import cv2
import numpy as np
# from yolo import PERSON_DETCTION

# detect = PERSON_DETCTION()

if __name__ == "__main__":
    
    # path="rtsp://admin:@dmin123@119.148.45.10:554/Streaming/Channels/201"
    path="vid.mp4"
    odapi = DetectorAPI()
    threshold = 0.8
        ...
        for (objectID, centroid) in objects.items():
            ...
            if to is None:
                ...
                if not to.counted:
                    ...
                    elif direction > 0 and centroid[1] >= line_down:
                        totalDown += 1
                        to.counted = True
