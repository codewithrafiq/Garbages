from project.ml.face_recog.project.libs.detector.mtcnn_cv2 import MTCNN
from project.ml.face_recog.project.libs.detector.align_trans import get_reference_facial_points, warp_and_crop_face
import numpy as np
...
class DetectionMtcnn():
    ...
    def get_cropped_face(self, image):
        ...
        for i,data in enumerate(result):
            ...
            r_landmarks = [list(keypoints['left_eye']),list(keypoints['right_eye']),list(keypoints['nose']),list(keypoints['mouth_left']),list(keypoints['mouth_right'])]
            # print(r_landmarks)
