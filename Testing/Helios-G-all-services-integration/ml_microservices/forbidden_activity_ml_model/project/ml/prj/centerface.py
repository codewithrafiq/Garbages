...
class CenterFace(object):
    def __init__(self, landmarks=True):
        ...
        if self.landmarks:
            self.net = cv2.dnn.readNetFromONNX('project/ml/models/onnx/centerface_bnmerged.onnx')
        else:
            self.net = cv2.dnn.readNetFromONNX('project/ml/models/onnx/centerface.onnx')
